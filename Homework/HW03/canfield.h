...
// Performs one move.  Simply repeats the last move if its parameter is true.
void move(bool repeatLastMove = false);
...
//Update the score as needed.  Should only be called after a move has been validated.
void updateScore();
