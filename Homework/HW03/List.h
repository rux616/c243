...
public:
    ...
    // Returns the element position of a given ListIterator in a list.  Returns -1 if the
    // ListIterator is not in the list for any reason, including if the list is empty, the
    // ListIterator being searched for is NULL, or it simply isn't in the list.
    int positionAtNode(ListIterator iter);



    //----------------------
    // Begin HW03 Additions
    //----------------------
