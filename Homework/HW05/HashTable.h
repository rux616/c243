...
//Sets some constants related to when the storage vector should be increased or decreased.
const float LF_INCREASE_THRESHOLD = 0.8;
const float LF_DECREASE_THRESHOLD = 0.2;

//Sets how fast the storage vector is increased or decreased in size.
...
private:
    ...
    // Checks the load factor of the table and resizes (up or down) if
    // needed.
    void resize();
